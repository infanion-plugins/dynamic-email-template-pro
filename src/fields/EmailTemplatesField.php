...
namespace ipcraft\emailtemplates\fields;

use ipcraft\emailtemplates\EmailTemplates;
use ipcraft\emailtemplates\assetbundles\emailtemplatesfieldfield\EmailTemplatesFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class EmailTemplatesField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('email-templates', 'EmailTemplatesField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'email-templates/_components/fields/EmailTemplatesField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(EmailTemplatesFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').EmailTemplatesEmailTemplatesField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'email-templates/_components/fields/EmailTemplatesField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

...
namespace ipcraft\dynamicemailtemplatepro\fields;

use ipcraft\dynamicemailtemplatepro\DynamicEmailTemplatePro;
use ipcraft\dynamicemailtemplatepro\assetbundles\dynamicemailtemplateprofieldfield\DynamicEmailTemplateProFieldFieldAsset;
...
/**
 * DynamicEmailTemplateProField Field
 *
 ...
 * @since     1.0.0
 */
class DynamicEmailTemplateProField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('dynamic-email-template-pro', 'DynamicEmailTemplateProField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'dynamic-email-template-pro/_components/fields/DynamicEmailTemplateProField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(DynamicEmailTemplateProFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').DynamicEmailTemplateProDynamicEmailTemplateProField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'dynamic-email-template-pro/_components/fields/DynamicEmailTemplateProField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

...
class DefualtController extends Controller
{
     ...
     * e.g.: actions/dynamic-email-template-pro/defualt
     *
     * @return mixed
     */
    public function actionIndex()
    {
        $result = 'Welcome to the DefualtController actionIndex() method';
     ...
     * e.g.: actions/dynamic-email-template-pro/defualt/do-something
     *
     * @return mixed
     */
    public function actionDoSomething()
    {
        $result = 'Welcome to the DefualtController actionDoSomething() method';

        return $result;
    }

    public function actionFetchTokenList()
    {
        $result = DynamicEmailTemplatePro::$plugin->tokenService->fetchToken();

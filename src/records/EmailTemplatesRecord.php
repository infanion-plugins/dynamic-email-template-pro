...
namespace ipcraft\emailtemplates\records;
 ...
 * @since     1.0.0
 */
class EmailTemplatesRecord extends ActiveRecord
{
    ...
    {
        return '{{%emailtemplates_emailtemplatesrecord}}';
    }
}
